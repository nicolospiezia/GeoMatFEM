...
[u,Du,du,f,p,sup,V] = deal(zeros(ndof,1));
...
[RESrec] = zeros(imax,nmax);
[RMAPrec] = zeros(15,nelem,imax,nmax);
...
for n = 1:nmax
    ...
    for iter = 1:imax
        ...
        g = zeros(ndof,1);                             
        [g,K,S,b,PL,PQ,FLAG,RMAP] = gKSolid(g,T,X,G,u,Du,nip,bn,PLn,nonlin); 
        RMAPrec(:,:,iter,n) = RMAP;
