...
% Save command: 
filename = ['es44prec', '_', num2str(dim),'D', '_', num2str(nonlin),'_p15'];
...
muw=1.0e-9;                     D=0;%sqrt(1.0*180*muw*(1-n)^2/(1-(1-n))^3);
...
clear pi P0 nu e k ks K mu0 lamdas lamda epsev0 epsev0s OCR Pc0 n muw D
...
incrf1 = zeros(1,nmax+1);
incrf2 = [(1.0/nmax:1/nmax:1.0) 0];%*2
incrv = ones(1,nmax+1);
